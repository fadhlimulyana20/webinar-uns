    ...
    <section class="content-section">
        <div class="container">
            <div class="d-flex justify-content-between mb-4">
                ...
                <a href="/webinar/create" class="btn btn-outline-success font-weight-bold my-auto">Tambah</a>
            </div>
            @if (count($webinars) > 0) 
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-success" href="/webinar/{{ $webinar->id }}/edit">Edit</a>
                                    <form action="{{ route('webinar.destroy', $webinar->id) }}" method="POST" enctype="multipart/form-data" class="d-inline">
                                        @csrf
                                        @method('DELETE')
